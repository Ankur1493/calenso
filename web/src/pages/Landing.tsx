    ...
    <div>
      <div className="flex justify-between px-16 py-10">
        <div>
          <h1>
            <a
              href="/"
              className="text-mainText font-heading font-extrabold text-4xl cursos-pointer"
            >
              CALENSO
            </a>
          </h1>
          ...
          <div className="bg-mainText rounded-3xl w-36 h-11 px-1.5 flex items-center">
            ...
            >
              <div className="flex flex-row justify-around">
                ...
                <div>
                  <p className="text-main font-heading font-semibold text-2xl ">
                    star us
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col w-6/12">
          <div className="flex flex-col items-left justify-center p-16 pt-32">
            <div className="w-full">
              <p className="font-heading text-secondText text-2xl">
                "Unlock your calendar's potential with Calenso.com -{" "}
              </p>
            </div>
            <div className="w-full">
              <p className="font-heading text-mainText text-3xl">
          ...
          <div className="flex justify-left px-16 pt-10">
            <div>
              <p className="font-secondHeading text-mainText text-8xl">
                Scheduling
              </p>
            </div>
          </div>
        </div>
        <div className="mr-16 w-6/12 h-5/12">
        ...
        <div className="flex flex-row w-11/12">
          <div className="w-3/12 p-8 bg-secondText border-second border-r-2 border-dashed rounded-s-3xl">
            <div className="flex items-center h-full">
              <a href="/">
                <p className="font-secondHeading text-2xl">Calenso.com/</p>
              </a>
            </div>
          </div>
          <div className="w-10/12 h-full rounded-e-3xl p-8 bg-input">
            <div className="flex items-center h-full">
              <input
                ...
                className="border-none decoration-none w-full text-2xl bg-transparent focus:outline-none"
              />
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-center">
        <div className="w-7/12 text-center">
          <p className="font-secondHeading text-mainText text-7xl font-bold">
      ...
      <div className="flex justify-center mt-32">
        <div className="w-7/12 text-center">
          <p className="font-secondHeading text-mainText text-6xl font-bold">
