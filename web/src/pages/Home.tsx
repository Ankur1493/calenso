...
function Home() {
  ...
  return (
    <div className="bg-second flex h-screen">
      <div className="flex flex-col justify-between border-r-2 border-secondText w-48 gap-2">
        <div>
          ...
          <div className="px-1">
            ...
            >
              ...
              <span
                className="hidden w-full justify-between truncate text-ellipsis lg:flex text-mainText"
          ...
          <div>
            ...
            >
              ...
              <span className="hidden w-full justify-between lg:flex">
                <div className="flex text-mainText">Settings</div>
              </span>
            </a>
          </div>
          <div>
